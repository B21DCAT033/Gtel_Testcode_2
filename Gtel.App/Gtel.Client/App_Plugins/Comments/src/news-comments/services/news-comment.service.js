...
class NewsCommentService {
  ...
  approve(item, accessToken) {
    return fetch(__privateGet(this, _rootApi) + "/approveComment", {
      method: "POST",
      headers: {
        "Authorization": `Bearer ${accessToken}`,
        "Content-Type": "application/json"
  ...
  reject(item, accessToken) {
    return fetch(__privateGet(this, _rootApi) + "/rejectComment", {
      method: "POST",
      headers: {
        "Authorization": `Bearer ${accessToken}`,
        "Content-Type": "application/json"
  ...
  delete(item, accessToken) {
    return fetch(__privateGet(this, _rootApi) + "/deleteComment", {
      method: "POST",
      headers: {
        "Authorization": `Bearer ${accessToken}`,
        "Content-Type": "application/json"
  ...
  deletes(item, accessToken) {
    return fetch(__privateGet(this, _rootApi) + "/deleteComments", {
      method: "POST",
      headers: {
        "Authorization": `Bearer ${accessToken}`,
        "Content-Type": "application/json"
...
//# sourceMappingURL=news-comment.service.js.map
