...
namespace Gtel.Client.Extensions
{
    /// <summary>
    ...
    public static class StringExtensions
    {
        ...
        public static string ToSentenceCase(this string str, bool invariantCulture = false)
        {
            ...
            var regex = new Regex("[a-z][A-Z]", RegexOptions.NonBacktracking, TimeSpan.FromSeconds(1));
            return regex.Replace(str, m => m.Value[0] + " " + (invariantCulture ? char.ToLowerInvariant(m.Value[1]) : char.ToLower(m.Value[1]))
            );
        }
        ...
        public static string ToSentenceCase(this string str, CultureInfo culture)
        {
            ...
            var regex = new Regex("[a-z][A-Z]", RegexOptions.NonBacktracking, TimeSpan.FromSeconds(1));
            return regex.Replace(str, m => m.Value[0] + " " + char.ToLower(m.Value[1], culture));
        }
        ...
        public static string ToSecureHash(this string str)
        {
