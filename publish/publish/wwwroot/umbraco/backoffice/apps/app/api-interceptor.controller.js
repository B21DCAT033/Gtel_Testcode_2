...
import { extractUmbNotificationColor, isUmbNotifications, UMB_NOTIFICATION_CONTEXT, UMB_NOTIFICATION_HEADER, } from '@umbraco-cms/backoffice/notification';
/**
...
export class UmbApiInterceptorController extends UmbControllerBase {
    ...
    #addUmbNotificationsInterceptor() {
        OpenAPI.interceptors.response.use((response) => {
            ...
            if (!isUmbNotifications(notifications))
                return response;
            ...
            for (const header of response.headers.entries()) {
                ...
                if (key !== UMB_NOTIFICATION_HEADER)
