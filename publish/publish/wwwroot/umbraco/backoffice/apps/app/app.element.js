...
let UmbAppElement = class UmbAppElement extends UmbLitElement {
    ...
    connectedCallback() {
        ...
        this.showSettingMenu = this.getAttribute('show-setting-menu') === 'true';
        this.showPackageMenu = this.getAttribute('show-package-menu') === 'true';
        this.showMemberMenu = this.getAttribute('show-member-menu') === 'true';
        this.#setup();
    }
    async #setup() {
        ...
        const appContext = new UmbAppContext(this, {
            backofficePath: this.backofficePath,
            serverUrl: this.serverUrl,
            serverConnection: this.#serverConnection,
        });
        appContext.backgroundImage = this.backgroundImage;
        appContext.gtelLogoImage = this.gtelLogoImage;
        appContext.gtelBrandImage = this.gtelBrandImage;
        appContext.showSettingMenu = this.showSettingMenu;
        appContext.showPackageMenu = this.showPackageMenu;
        appContext.showMemberMenu = this.showMemberMenu;
...
], UmbAppElement.prototype, "backgroundImage", void 0);
__decorate([
    property({ type: String, attribute: 'gtel-logo-image' })
], UmbAppElement.prototype, "gtelLogoImage", void 0);
__decorate([
    property({ type: String, attribute: 'gtel-brand-image' })
], UmbAppElement.prototype, "gtelBrandImage", void 0);
__decorate([
    property({ type: Boolean, attribute: 'show-setting-menu' })
], UmbAppElement.prototype, "showSettingMenu", void 0);
__decorate([
    property({ type: Boolean, attribute: 'show-package-menu' })
], UmbAppElement.prototype, "showPackageMenu", void 0);
__decorate([
    property({ type: Boolean, attribute: 'show-member-menu' })
], UmbAppElement.prototype, "showMemberMenu", void 0);
