 ...
 *
 * Language Alias: vi
 * Language Int Name: English (VN)
 * Language Local Name: English (VN)
 * Language LCID:
...
export default {
	...
	gtelPortal: {
		bannerText: 'Trang quản trị nội dung',
		showAll: 'Hiện tất cả',
		hideAll: 'Ẩn tất cả',
		outroTitle: 'GTEL',
		outroContent:
			'Tiên phong trong việc kiến tạo xã hội số, xây dựng và phát triển hạ tầng số, đảm bảo hệ thống thông tin liên lạc có tính sẵn sàng, an toàn và có độ dự phòng cao cho lực lượng CAND, nghiên cứu, ứng dụng và cung cấp các giải pháp số chất lượng cao cho tổ chức, người dân.',
		outroActionBackToMainPage: 'Trở lại trang chủ',
	},
