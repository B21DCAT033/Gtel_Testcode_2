import { U as C } from "./block-workspace.modal-token-N1xnaaIe.js";
...
y = function() {
  ...
  this._tabs.length > 0 && this._tabs?.forEach((e) => {
    ...
    t.push({
      path: `tab/${P(s)}`,
      component: () => import("./block-workspace-view-edit-tab.element-Cma7r_Kj.js"),
      setup: (o) => {
...
//# sourceMappingURL=block-workspace-view-edit.element-CuptSWUT.js.map
