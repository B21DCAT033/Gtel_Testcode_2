import { i as P, b as D, e as L } from "./index-Cc47Hgez.js";
import { U as V } from "./constants-U4qMfj-5.js";
...
import { css as I, property as E, state as h, customElement as U, html as g, repeat as W } from "@umbraco-cms/backoffice/external/lit";
...
import { U as q } from "./block-grid-block.element-DQICgvM8.js";
...
}, w = (e, t, r) => t.has(e) || R("Cannot " + r), m = (e, t, r) => (w(e, t, "read from private field"), t.get(e)), v = (e, t, r) => t.has(e) ? R("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), f = (e, t, r, s) => (w(e, t, "write to private field"), t.set(e, r), r), C = (e, t, r) => (w(e, t, "access private method"), r), S, p, b, y, A, x;
let n = class extends T {
    ...
    super(), v(this, y), v(this, S, new J(this)), v(this, p, 12), v(this, b), this._value = [], new Y(this, L).addAdditionalPath("block-grid-area-type").onSetup(() => {
      ...
      return {
        data: {
          ...
          preset: { columnSpan: e === Math.round(e) ? e : this._areaGridColumns, alias: C(this, y, x).call(this, "area") }
        },
        modal: { size: "large" }
      };
      ...
      this.observe(
        ...
        (t) => {
          f(this, b, t > 0 ? t : null), C(this, y, A).call(this);
        },
  ...
  set config(e) {
    ...
    typeof t == "number" && t > 0 ? f(this, p, t ?? null) : f(this, p, 12), C(this, y, A).call(this);
  }
  render() {
    return this._areaGridColumns ? g`${this._styleElement}
					<div
      ...
      this.value,
      (e) => e.key,
      (e) => g`<umb-block-area-config-entry
...
//# sourceMappingURL=property-editor-ui-block-grid-areas-config.element-QPzA6bia.js.map
