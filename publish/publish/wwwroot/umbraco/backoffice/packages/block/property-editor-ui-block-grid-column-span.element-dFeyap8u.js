...
u = function(e) {
  const r = this.value ?? [];
  r.find((o) => o.columnSpan === e) ? this.value = r.filter((o) => o.columnSpan !== e) : this.value = [...r, { columnSpan: e }], this.dispatchEvent(new y());
};
n.styles = [
  w,
  m`
...
//# sourceMappingURL=property-editor-ui-block-grid-column-span.element-dFeyap8u.js.map
