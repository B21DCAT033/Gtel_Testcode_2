...
import { html as f, state as v, property as d, customElement as g } from "@umbraco-cms/backoffice/external/lit";
...
var E = Object.defineProperty, S = Object.getOwnPropertyDescriptor, c = (t) => {
  throw TypeError(t);
}, h = (t, e, i, o) => {
  for (var a = o > 1 ? void 0 : o ? S(e, i) : e, u = t.length - 1, p; u >= 0; u--)
    (p = t[u]) && (a = (o ? p(e, i, a) : p(a)) || a);
  return o && a && E(e, i, a), a;
}, y = (t, e, i) => e.has(t) || c("Cannot " + i), s = (t, e, i) => (y(t, e, "read from private field"), i ? i.call(t) : e.get(t)), _ = (t, e, i) => e.has(t) ? c("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, i), k = (t, e, i, o) => (y(t, e, "write to private field"), e.set(t, i), i), m, n, l;
let r = class extends b {
  constructor() {
    super(...arguments), _(this, m, (t) => t.unique.endsWith("css")), _(this, n, !1), _(this, l, new P()), this._limitMin = 0, this._limitMax = 1 / 0;
  }
  set value(t) {
  ...
  _onChange(t) {
    s(this, n) ? this._value = t.target.selection[0] : this._value = t.target.selection, this.dispatchEvent(new M());
  }
...
//# sourceMappingURL=property-editor-ui-block-grid-layout-stylesheet.element-1-vpOGIY.js.map
