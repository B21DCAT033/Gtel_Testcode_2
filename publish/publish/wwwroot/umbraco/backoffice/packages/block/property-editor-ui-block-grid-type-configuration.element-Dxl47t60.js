import { repeat as U, html as _, ifDefined as O, nothing as A, css as R, property as E, state as m, customElement as S } from "@umbraco-cms/backoffice/external/lit";
...
import { UMB_BLOCK_GRID_TYPE_WORKSPACE_MODAL as V, UMB_BLOCK_GRID_TYPE as I } from "@umbraco-cms/backoffice/block-grid";
...
let p = class extends x {
  constructor() {
    super(), d(this, s), d(this, G, new K(this, {
      ...
      this,
      V
    ).addAdditionalPath(I).observeRouteBuilder((t) => {
      const e = t({});
  ...
  render() {
    return _`<div id="groups">
      ...
      (t) => t.key,
      (t) => _`<div class="group" data-umb-group-key=${O(t.key)}>
						${t.key ? n(this, s, M).call(this, t.key, t.name) : A}
...
p = h([
  S("umb-property-editor-ui-block-grid-type-configuration")
], p);
const rt = p;
export {
...
//# sourceMappingURL=property-editor-ui-block-grid-type-configuration.element-Dxl47t60.js.map
