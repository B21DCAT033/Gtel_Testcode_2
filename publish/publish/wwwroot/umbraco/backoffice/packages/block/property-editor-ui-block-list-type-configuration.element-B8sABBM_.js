import "./input-block-type.element-BR7siMdp.js";
...
import { html as g, property as f, state as k, customElement as w } from "@umbraco-cms/backoffice/external/lit";
...
let a = class extends C {
  constructor() {
    super(), v(this, n), v(this, s), this.value = [], y(this, s)?.destroy(), L(this, s, new b(this, U).addAdditionalPath(d).onSetup(() => ({ data: { entityType: d, preset: {} }, modal: { size: "large" } })).observeRouteBuilder((t) => {
      const e = t({});
...
u = function(t) {
  t.stopPropagation(), this.value = t.target.value, this.dispatchEvent(new P());
};
p([
  f({ attribute: !1 })
], a.prototype, "value", 2);
...
a = p([
  w("umb-property-editor-ui-block-list-type-configuration")
], a);
const I = a;
export {
...
//# sourceMappingURL=property-editor-ui-block-list-type-configuration.element-B8sABBM_.js.map
