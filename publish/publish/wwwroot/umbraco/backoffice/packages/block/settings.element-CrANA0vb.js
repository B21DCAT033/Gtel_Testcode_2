import { html as b, css as _, state as y, customElement as f } from "@umbraco-cms/backoffice/external/lit";
...
var g = Object.defineProperty, V = Object.getOwnPropertyDescriptor, c = (e) => {
  ...
  for (var r = l > 1 ? void 0 : l ? V(t, a) : t, p = e.length - 1, n; p >= 0; p--)
    (n = e[p]) && (r = (l ? n(t, a, r) : n(r)) || r);
  return l && r && g(t, a, r), r;
}, h = (e, t, a) => t.has(e) || c("Cannot " + a), s = (e, t, a) => (h(e, t, "read from private field"), a ? a.call(e) : t.get(e)), d = (e, t, a) => t.has(e) ? c("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, a), A = (e, t, a, l) => (h(e, t, "write to private field"), t.set(e, a), a), i, u;
let o = class extends v {
  constructor() {
    super(), d(this, i), d(this, u, (e) => {
      ...
      A(this, i, e), this.observe(await s(this, i).propertyValueByAlias("minAllowed"), (t) => {
        this._minValue = t ?? 0;
      }), this.observe(await s(this, i).propertyValueByAlias("maxAllowed"), (t) => {
...
o = m([
  f("umb-block-grid-area-type-workspace-view")
], o);
const $ = o;
export {
...
//# sourceMappingURL=settings.element-CrANA0vb.js.map
