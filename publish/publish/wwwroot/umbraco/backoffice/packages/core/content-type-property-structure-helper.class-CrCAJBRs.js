...
class c extends o {
  constructor(e) {
    super(e), this.#t = new a([], (t) => t.id), this.propertyStructure = this.#t.asObservable(), this.#r = new Promise((t) => {
      this.#s = t;
  ...
  async isOwnerProperty(e) {
    if (await this.#r, !!this.#e)
      return this.#e.ownerContentTypeObservablePart((t) => t?.properties.some((r) => r.id === e));
  }
...
//# sourceMappingURL=content-type-property-structure-helper.class-CrCAJBRs.js.map
