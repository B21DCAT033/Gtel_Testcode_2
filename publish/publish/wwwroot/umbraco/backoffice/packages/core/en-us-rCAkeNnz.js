...
To manage your website, simply open the Umbraco backoffice and start adding content, updating the templates and stylesheets or add new functionality`,
  ...
  gtelPortal: {
    bannerText: "Content Management System",
    showAll: "Show all",
    hideAll: "Hide all",
    outroTitle: "GTEL",
    outroContent: "Tiên phong trong việc kiến tạo xã hội số, xây dựng và phát triển hạ tầng số, đảm bảo hệ thống thông tin liên lạc có tính sẵn sàng, an toàn và có độ dự phòng cao cho lực lượng CAND, nghiên cứu, ứng dụng và cung cấp các giải pháp số chất lượng cao cho tổ chức, người dân.",
    outroActionBackToMainPage: "Back to main page"
  }
};
export {
  n as default
};
//# sourceMappingURL=en-us-rCAkeNnz.js.map
