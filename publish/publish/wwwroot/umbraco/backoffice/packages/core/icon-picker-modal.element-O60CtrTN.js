...
import { UMB_ICON_REGISTRY_CONTEXT as F } from "@umbraco-cms/backoffice/icon";
var P = Object.defineProperty, U = Object.getOwnPropertyDescriptor, x = (e) => {
  throw TypeError(e);
}, c = (e, t, o, n) => {
  for (var r = n > 1 ? void 0 : n ? U(t, o) : t, p = e.length - 1, m; p >= 0; p--)
    (m = e[p]) && (r = (n ? m(t, o, r) : m(r)) || r);
  return n && r && P(t, o, r), r;
...
let i = class extends z {
  constructor() {
    super(), f(this, a), f(this, s), this._colorList = I.filter((e) => !e.legacy), this._currentColor = "text", this.consumeContext(F, (e) => {
...
//# sourceMappingURL=icon-picker-modal.element-O60CtrTN.js.map
