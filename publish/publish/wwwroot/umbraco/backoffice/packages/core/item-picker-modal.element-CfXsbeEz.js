import { nothing as _, when as v, repeat as x, ifDefined as d, html as l, css as g, state as y, customElement as $ } from "@umbraco-cms/backoffice/external/lit";
...
}, z = (t, e, i) => e.has(t) || m("Cannot " + i), M = (t, e, i) => e.has(t) ? m("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, i), c = (t, e, i) => (z(t, e, "access private method"), i), r, f, p, b;
let s = class extends C {
  constructor() {
    super(...arguments), M(this, r), this._filtered = [];
  }
  connectedCallback() {
    super.connectedCallback(), this.data && (this._filtered = this.data.items);
  }
  render() {
    if (!this.data) return _;
...
//# sourceMappingURL=item-picker-modal.element-CfXsbeEz.js.map
