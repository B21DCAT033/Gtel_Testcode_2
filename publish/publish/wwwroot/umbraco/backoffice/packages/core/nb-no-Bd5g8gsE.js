const t = {
  ...
  content: {
    ...
    scheduledPublishDocumentation: '<a href="https://docs.umbraco.com/umbraco-cms/fundamentals/data/scheduled-publishing#timezones" target="_blank" rel="noopener">Hva betyr dette?</a>',
  ...
  dictionaryItem: {
    description: "Rediger de forskjellige språkversjonene for ordbokelementet '%0%' under. Du kan legge til flere språk under 'språk' i menyen til venstre.",
    displayName: "Språk",
  ...
  grid: {
    ...
    gridLayoutsDetail: "Et oppsett er det overordnede arbeidsområdet for din grid - du vil typisk kun behøve ett eller to",
  ...
  references: {
    ...
    deleteWarning: "Dette elementet eller underelementer blir referert av andre elementer. Sletting kan føre til ødelagte koblinger på nettstedet ditt.",
    unpublishWarning: "Dette elementet eller underelementer blir referert av andre elementer. Avpublisering  kan føre til ødelagte koblinger på nettstedet ditt.",
    ...
    labelMoreReferences: (e) => e === 1 ? "...og ett element til" : `...og ${e} elementer til`
  },
  logViewer: {
  ...
  welcomeDashboard: {
    ...
    ourUmbracoDescription: "På 'Our Umbraco', den offisielle fellesskapssiden, finner du all informasjon relatert til Umbraco. Enten du trenger svar på et spørsmål, kule plugins eller en guide til hvordan du gjør noe i Umbraco, er verdens beste og vennligste fellesskap bare et klikk unna.",
...
//# sourceMappingURL=nb-no-Bd5g8gsE.js.map
