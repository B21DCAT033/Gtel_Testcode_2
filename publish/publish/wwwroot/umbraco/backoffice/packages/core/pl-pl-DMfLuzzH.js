const e = {
  ...
  assignDomain: {
    ...
    setLanguage: "Język",
    setLanguageHelp: `Wybierz język dla węzła,<br /> lub wybierz dziedziczenie języka z węzła rodzica. Zostanie to zastosowane<br />
  ...
  content: {
    ...
    parentNotPublished: "Ten dokument jest opublikowany, ale jest niewidoczny, ponieważ jego rodzic '%0%' nie jest opublikowany",
    ...
    sortHelp: 'Aby posortować gałęzie, po prostu przeciągnij gałąż lub kliknij na jednym z nagłówków kolumn. Możesz wybrać kilka gałęzi poprzez przytrzymanie klawisza "shift" lub "control" podczas zaznaczania',
    ...
    scheduledPublishDocumentation: '<a href="https://docs.umbraco.com/umbraco-cms/fundamentals/data/scheduled-publishing#timezones" target="_blank" rel="noopener">Co to oznacza?</a>',
  ...
  blueprints: {
    ...
    blueprintDescription: "Szablon Zawartości to predefiniowana zawartość, którą edytor może wybrać, aby użyć jej jako podstawę do stworzenia nowej zawartości"
  },
  media: {
  ...
  create: {
    ...
    noDocumentTypes: 'Brak dostępnych dozwolonych typów dokumentów. Należy włączyć je w ustawieniach sekcji pod <strong>"typy dokumentów"</strong>.',
    noMediaTypes: 'Brak dostępnych dozwolonych typów mediów. Należy włączyć je w ustawieniach sekcji pod <strong>"typy mediów"</strong>.',
  ...
  dashboard: {
    ...
    dontShowAgain: "- Ukryj",
    nothinghappens: "Jeśli Umbraco się nie otwiera, prawdopodobnie musisz zezwolić tej stronie na otwieranie wyskakujących okienek",
  ...
  defaultdialogs: {
    ...
    recycleBinDeleting: "Zawartość kosza jest teraz usuwana. Proszę nie zamykać tego okna do momentu zakończenia procesu.",
    ...
    regexSearchError: "Serwis <a target='_blank' rel='noopener' href='http://regexlib.com'>regexlib.com</a> aktualnie nie jest dostępny, na co nie mamy wpływu. Bardzo przepraszamy za te utrudnienia.",
    regexSearchHelp: "Przeszukaj dla wyrażeń regularnych, aby dodać regułę sprawdzającą do formularza. Np. 'email' 'URL'",
    removeMacro: "Usuń Makro",
    requiredField: "Pole wymagane",
    sitereindexed: "Strona została przeindeksowana",
    siterepublished: "Cache strony zostało odświeżone. Cała opublikowana zawartość jest teraz aktualna. Natomiast cała nieopublikowana zawartość ciągle nie jest widoczna",
    siterepublishHelp: "Cache strony zostanie odświeżone. Cała zawartość opublikowana będzie aktualna, lecz nieopublikowana zawartość pozostanie niewidoczna",
  ...
  dictionaryItem: {
    description: `Edytuj różne wersje językowe dla elementu słownika '%0%' poniżej. Możesz dodać dodatkowe języki w menu "Języki" po lewej stronie.`,
  ...
  errorHandling: {
    ...
    errorChangingProviderPassword: "Bieżący dostawca członkowstwa nie obsługuje zmiany hasła (EnablePasswordRetrieval musi mieć wartość 'true')",
  ...
  errors: {
    ...
    codemirroriewarning: "Pomimo tego, że CodeMirror jest włączony w konfiguracji, jest on wyłączony w Internet Explorerze ze względu na swoją niestabilność.",
    ...
    pictureResizeBiggerThanOrg: "Chcesz utworzyć obraz większy niż rozmiar oryginalny. Czy na pewno chcesz kontynuować?",
...
`,
    databaseInstallDone: "Umbraco %0% zostało skopiowane do Twojej bazy danych. Naciśnij <strong>Dalej</strong>, aby kontynuować.",
    databaseText: `Aby zakończyć ten etap instalacji, będziesz musiał podać parametry połączenia do Twojego serwera baz danych ("connection string").<br />
    ...
    databaseUpgrade: `
                ...
                `,
    databaseUpgradeDone: `Twoja baza danych została zaktualizowana do wersji %0%.<br />Naciśnij przycisk <strong>Dalej</strong>, aby
                kontynuować.`,
    databaseUpToDate: "Twoja baza danych nie wymaga aktualizacji! Naciśnij przycisk <strong>Dalej</strong>, aby kontynuować kreatora instalacji.",
    defaultUserChangePass: "<strong>Hasło domyślnego użytkownika musi zostać zmienione!</strong>",
    defaultUserDisabled: "<strong>Konto domyślnego użytkownika zostało wyłączone lub nie ma on dostępu do Umbraco!</strong></p><p>Żadne dodatkowe czynności nie są konieczne. Naciśnij <strong>Dalej</strong>, aby kontynuować.",
    defaultUserPassChanged: "<strong>Hasło domyślnego użytkownika zostało zmienione od czasu instalacji!</strong></p><p>Żadne dodatkowe czynności nie są konieczne. Naciśnij <strong>Dalej</strong>, aby kontynuować.",
    ...
    permissionsAlmostPerfect: `<strong>Twoje ustawienia uprawnień są prawie idealne!</strong><br /><br />
    ...
    permissionsHowtoResolveText: "Obejrzyj nasz <strong>samouczek</strong>, pokazujący jak ustawić uprawnienia dostępu do folderów dla Umbraco, albo przeczytaj wersję tekstową.",
    permissionsMaybeAnIssue: `<strong>Twoje ustawienia uprawnień mogą stanowić problem!</strong>
                <br /><br />
                Umbraco będzie działało bez problemów, ale nie będzie możliwa instalacja pakietów, które są rekomendowane, aby w pełni wykorzystać możliwości Umbraco.`,
    permissionsNotReady: `<strong>Twoje ustawienia uprawnień nie są gotowe na Umbraco!</strong>
                <br /><br />
                Aby Umbraco mogło działać musisz uaktualnić swoje ustawienia zabezpieczeń.`,
    permissionsPerfect: `<strong>Twoje ustawienia uprawnień są idealne!</strong><br /><br />
    ...
    permissionsResolveFolderIssuesLink: "Kliknij ten link, aby uzyskać więcej informacji na temat problemów z ASP.NET i tworzeniem folderów.",
    ...
    theEndBrowseSite: `<h3>Przeglądaj swoją nową stronę</h3>
                Pakiet Runway został zainstalowany, zobacz zatem jak wygląda Twoja nowa strona.`,
    theEndFurtherHelp: `<h3>Dalsza pomoc i informacje</h3>
    ...
    theEndInstallSuccess: `Możesz <strong>rozpocząć natychmiast</strong> klikając przycisk "Uruchom Umbraco" poniżej. <br />Jeżeli jesteś <strong>nowy dla Umbraco</strong>
                znajdziesz mnóstwo materiałów na naszych stronach "jak rozpocząć".`,
    theEndOpenUmbraco: `<h3>Uruchom Umbraco</h3>
    ...
    watch: "Zobacz",
    welcomeIntro: `Ten kreator przeprowadzi Cię przez proces konfiguracji <strong>Umbraco %0%</strong> dla świeżej instalacji lub aktualizacji z wersji 3.0.
                <br /><br />
  ...
  login: {
    ...
    requestPasswordResetConfirmation: "E-mail z instrukcjami do zresetowania hasła zostanie wysłany, jeśli zgadza się z naszą bazą danych",
    ...
    resetPasswordEmailCopyFormat: '<p>Twoja nazwa użytkownika do zalogowania się w Umbraco backoffice to: <strong>%0%</strong></p><p>Kliknij <a href="%1%"><strong>tutaj</strong></a>, aby zresetować Twoje hasło lub kopiuj/wklej ten URL w przeglądarce:</p><p><em>%1%</em></p>'
  },
  main: {
  ...
  moveOrCopy: {
    ...
    notValid: "Działanie jest niedozwolone, ponieważ nie masz odpowiednich uprawnień w 1 lub więcej dokumentach dzieci.",
  ...
  packager: {
    ...
    noPackagesDescription: "Nie masz żadnych zainstalowanych pakietów. Zainstaluj lokalny pakiet poprzez wybranie go ze swojego komputera lub przeglądaj dostępne pakiety, używając ikony <strong>'Pakiety'</strong> w prawym górnym rogu ekranu",
    ...
    packageCompatibilityDescription: "Według raportów członków społeczności, ten pakiet jest zgodny z następującymi wersjami Umbraco. Pełna zgodność nie może być zagwarantowana dla wersji zaraportowanych poniżej 100%",
    ...
    packageNoItemsText: `Ten plik pakietu nie zawiera żadnych elementów do odinstalowania<br/><br/>
    ...
    packageUninstallText: `Poniżej możesz odznaczyć elementy, których nie chcesz usunąć tym razem. Kiedy klikniesz "potwierdź odinstalowanie", wszystkie zaznaczone elementy zostaną usunięte.<br/>
  ...
  paste: {
    ...
    errorMessage: "Tekst, który wklejasz zawiera specjalne znaki formatujące. Prawdopodobnie tekst pochodzi z programu Microsoft Word. Umbraco może usunąć specjalne znaki lub formatowanie automatycznie, więc skopiowana treść będzie lepiej dopasowana do wyświetlania w Internecie.",
  ...
  publicAccess: {
    ...
    paAdvancedHelp: "Jeśli chcesz kontrolować dostęp do strony przy użyciu uwierzytelniania opartego na rolach, <br /> użyj grup członkowskich Umbraco ",
  ...
  publish: {
    ...
    publishHelp: `Kliknij <em> OK </ em>, aby publikować <strong>% 0% </ strong> i spowodować upublicznienie całej zawartości.<br/><br/>
  ...
  rollback: {
    diffHelp: "Tu pokazane są różnice pomiędzy bieżącą oraz wybraną wersją <br/><del>Czerwony</del> tekst nie będzie pokazany w wybranej wersji, <ins>zielony tekst został dodany</ins>",
    documentRolledBack: "Dokument został przywrócony",
    htmlHelp: "Tu widać wybraną wersję jako html, jeżeli chcesz zobaczyć różnicę pomiędzy 2 wersjami w tym samym czasie, użyj podglądu różnic",
  ...
  settings: {
    ...
    importDocumentTypeHelp: 'By zaimportować typ dokumentu, wskaż plik ".udt" na swoim komputerze, klikając przycisk "Przeglądaj" i kliknij "Importuj" (zostaniesz poproszony o potwierdzenie w następnym kroku)',
    ...
    noPropertiesDefinedOnTab: 'Żadne właściwości nie zostały zdefiniowane dla tej zakładki. Kliknij w link "dodaj nową właściwość", który znajduje się na górze strony, aby stworzyć nową właściwość.',
    addIcon: "Dodaj ikonę"
  },
  sort: {
    ...
    sortHelp: "Przesuń poszczególne elementy w górę oraz w dół aż będą w odpowiedniej kolejności lub kliknij na nagłówku kolumny, aby posortować całą kolekcję elementów",
  ...
  template: {
    ...
    insertDictionaryItemDesc: "Element słownika to miejsce, gdzie można wstawić przetłumaczony tekst, co ułatwia tworzenie projektów dla wielojęzycznych stron.",
    insertMacro: "Makro",
    insertMacroDesc: `
    ...
    insertPageFieldDesc: "Wyświetla wartość danego pola z bieżącej strony z opcjami modyfikacji wartości lub powrotu do alernatywnych wartości.",
  ...
  grid: {
    ...
    gridLayoutsDetail: "Układy to ogólne pole pracy dla edytora siatki, przeważnie będziesz potrzebować tylko jednego lub dwóch różnych układów",
  ...
  contentTypeEditor: {
    ...
    enableListViewDescription: "Konfiguruje element treści, aby pokazać sortowaną i możliwą do przeszukiwania listę jego dzieci, dzieci nie będą wyświetlone w drzewie",
    ...
    compositionsDescription: "Odziedzicz zakładki i właściwości z istniejącego typu dokumentu. Nowe zakładki będą dodane do bieżącego typu dokumentu lub złączone jeśli zakładka z identyczną nazwą już istnieje.",
    ...
    usingThisDocument: "używający tego typu dokumentu zostanie usunięty na stałe, proszę potwierdź czy chcesz usunąć także te.",
    usingThisMedia: "używający tych mediów zostanie usunięty na stałe, proszę potwierdź czy chcesz usunąć także te.",
    usingThisMember: "używający tego typu członka zostanie usunięty na stałe, proszę potwierdź czy chcesz usunąć także te",
  ...
  translation: {
    ...
    translationDoneHelp: "Możesz podejrzeć stronę, którą właśnie przetłumaczyłeś, poprzez kliknięcie poniżej. Jeżeli strona oryginalna istnieje, możesz porównać obie wersje",
  ...
  update: {
    ...
    updateNoServerError: "Wystąpił błąd podczas sprawdzania aktualizacji. Przeglądnij trace-stack dla dalszych informacji"
  },
  user: {
    ...
    changePasswordDescription: 'Możesz zmienić swoje hasło w Umbraco backoffice przez wypełnienie formularza poniżej i kliknięcie przycisku "Zmień hasło"',
  ...
  healthcheck: {
    ...
    checkErrorMessageDifferentExpectedValue: "Oczekiwana jest wartość '%1%' dla '%2%' w pliku konfiguracyjnym '%3%', ale znaleziono '%0%'.",
    ...
    macroErrorModeCheckErrorMessage: "MacroErrors są ustawione na '%0%' co uniemożliwi częściowe lub całkowite załadowanie stron w Twojej witrynie jeśli wystąpią jakiekolwiek błędy w makro. Korekta ustawi wartość na '%1%'.",
    ...
    compilationDebugCheckErrorMessage: "Tryb kompilacji debugowania jest obecnie włączony. Zaleca się wyłączenie tego ustawienia przed wypuszczeniem strony na produkcję.",
    clickJackingCheckHeaderFound: "Nagłówek lub meta-tag <strong>X-Frame-Options</strong> używany do kontrolowania czy strona może być IFRAME'owana przez inną został znaleziony.",
    clickJackingCheckHeaderNotFound: "Nagłówek lub meta-tag <strong>X-Frame-Options</strong> używany do kontrolowania czy strona może być IFRAME'owana przez inną nie został znaleziony.",
    excessiveHeadersFound: "Znaleziono następujące nagłówki, ujawniające informacje o technologii strony: <strong>%0%</strong>.",
    ...
    notificationEmailsCheckErrorMessage: "E-mail do powiadomień jest nadal ustawiony na domyślną wartość <strong>%0%</strong>."
  },
  redirectUrls: {
    ...
    noRedirectsDescription: "Kiedy nazwa opublikowanej strony zostanie zmieniona lub zostanie ona przeniesiona, zostanie stworzone automatyczne przekierowanie na nową stronę.",
...
//# sourceMappingURL=pl-pl-DMfLuzzH.js.map
