...
}, c = (t, r, e) => r.has(t) || m("Cannot " + e), w = (t, r, e) => (c(t, r, "read from private field"), e ? e.call(t) : r.get(t)), P = (t, r, e) => r.has(t) ? m("Cannot add the same private member more than once") : r instanceof WeakSet ? r.add(t) : r.set(t, e), O = (t, r, e, i) => (c(t, r, "write to private field"), r.set(t, e), e), n;
function C(t) {
  return [{ meta: t.meta }];
}
...
//# sourceMappingURL=property-action-menu.element-DHt2QH7Q.js.map
