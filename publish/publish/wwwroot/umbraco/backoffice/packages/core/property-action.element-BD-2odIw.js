...
var A = Object.defineProperty, U = Object.getOwnPropertyDescriptor, v = (t) => {
  ...
  for (var i = a > 1 ? void 0 : a ? U(e, r) : e, p = t.length - 1, c; p >= 0; p--)
    (c = t[p]) && (i = (a ? c(e, r, i) : c(i)) || i);
...
d = async function(t) {
  this._href || (t.stopPropagation(), await u(this, n)?.execute()), this.dispatchEvent(new E());
};
y = function(t) {
  t.stopPropagation();
};
...
//# sourceMappingURL=property-action.element-BD-2odIw.js.map
