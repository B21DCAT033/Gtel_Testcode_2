...
import "./paths-CAM7NxJ3.js";
import { U as W } from "./property-type-workspace.context-token-Cbb8UB1S.js";
import { html as r, nothing as y, css as G, state as u, query as Z, customElement as H } from "@umbraco-cms/backoffice/external/lit";
import { generateAlias as _ } from "@umbraco-cms/backoffice/utils";
import { umbBindToValidation as m } from "@umbraco-cms/backoffice/validation";
import { UmbLitElement as Y, umbFocus as F } from "@umbraco-cms/backoffice/lit-element";
...
var j = Object.defineProperty, J = Object.getOwnPropertyDescriptor, b = (e) => {
  throw TypeError(e);
}, s = (e, t, o, c) => {
  for (var l = c > 1 ? void 0 : c ? J(t, o) : t, p = e.length - 1, h; p >= 0; p--)
    (h = e[p]) && (l = (c ? h(t, o, l) : h(l)) || l);
  return c && l && j(t, o, l), l;
}, v = (e, t, o) => t.has(e) || b("Cannot " + o), Q = (e, t, o) => (v(e, t, "read from private field"), t.get(e)), g = (e, t, o) => t.has(e) ? b("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, o), ee = (e, t, o, c) => (v(e, t, "write to private field"), t.set(e, o), o), i = (e, t, o) => (v(e, t, "access private method"), o), d, a, f, $, z, T, w, x, C, V, k, E, O, A, S, M, D, L, B, I, P, U, N, q, R;
let n = class extends Y {
  constructor() {
    super(), g(this, a), g(this, d), this._customValidationOptions = [
      {
    ...
    ], this._aliasLocked = !0, this._autoGenerateAlias = !0, this.consumeContext(W, (e) => {
      ee(this, d, e), this.observe(
        e.data,
        (t) => {
			...
			<uui-box class="uui-text">
				...
				<umb-form-validation-message>
					<umb-data-type-flow-input
						...
						@change=${i(this, a, T)}
						required
						${m(this, "$.dataType.unique")}></umb-data-type-flow-input>
				</umb-form-validation-message>
				<hr />
				<div class="container">
					<b><umb-localize key="validation_validation">Validation</umb-localize></b>
					${i(this, a, U).call(this)}
				...
				<div class="container">
					...
					<div id="appearances">${i(this, a, I).call(this)} ${i(this, a, P).call(this)}</div>
				</div>
				${i(this, a, B).call(this)}
			</uui-box>
		`;
  }
};
...
B = function() {
  return this._entityType !== "member-type" ? y : r` <hr />
			<div class="container">
				<b style="margin-bottom: var(--uui-size-space-3)">
...
q = function() {
  return this._contentTypeVariesByCulture || this._contentTypeVariesBySegment ? r` <div class="container">
						<b><umb-localize key="contentTypeEditor_variantsHeading">Allow variations</umb-localize></b>
						${this._contentTypeVariesByCulture ? i(this, a, R).call(this) : ""}
					</div>
					<hr />` : "";
};
R = function() {
...
n = s([
  H("umb-property-type-workspace-view-settings")
], n);
const ce = n;
export {
...
//# sourceMappingURL=property-workspace-view-settings.element-DJCXbDjU.js.map
