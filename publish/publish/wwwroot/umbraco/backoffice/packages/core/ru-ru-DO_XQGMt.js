const e = {
  ...
  dictionaryItem: {
    description: "Ниже Вы можете указать различные переводы данной статьи словаря '%0%'. Добавить другие языки можно, воспользовавшись пунктом 'Языки' в меню слева.",
...
//# sourceMappingURL=ru-ru-DO_XQGMt.js.map
