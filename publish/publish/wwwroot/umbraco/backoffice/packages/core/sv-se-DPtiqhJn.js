const e = {
  ...
  assignDomain: {
    ...
    setDomains: "Domäner",
    setLanguage: "Kultur",
    setLanguageHelp: `Sätt kulturen för noder under aktuell nod,<br /> eller ärv kulturen från föregående noder. Appliceras även<br />
     på befintlig nod.`
  },
  auditTrailsMedia: {
  ...
  blueprints: {
    ...
    blueprintDescription: "En innehållsmall är fördefinierat innehåll som en redaktör kan välja att använda som grund för att skapa nytt innehåll"
  },
  buttons: {
  ...
  content: {
    ...
    parentNotPublished: "Detta dokument är publicerat men syns inte eftersom den överordnade sidan %0% inte är publicerad",
    ...
    sortHelp: "För att sortera noderna, dra i dem eller klicka på någon av kolumnrubrikerna. Du kan markera flera noder samtidigt genom att hålla nere SHIFT eller CONTROL medan du klickar",
  ...
  create: {
    ...
    noDocumentTypes: 'Det finns inga giltiga dokumenttyper tillgängliga. Du måste aktivera dessa under sektionen inställningar och under <strong>"dokumenttyper"</strong>.',
    noMediaTypes: 'Det finns inga giltiga mediatyper tillgängliga. Du måste aktivera dessa under sektionen inställningar och under <strong>"mediatyper"</strong>.',
    updateData: "Välj typ och rubrik"
  },
  dashboard: {
    browser: "Surfa på din webbplats",
    dontShowAgain: "- Dölj",
    nothinghappens: "Om Umbraco inte öppnas kan det bero på att du måste tillåta poppuppfönster att öppnas från denna webbplats",
  ...
  visuallyHiddenTexts: {
    ...
    searchInputDescription: `När det finns automatförslag, använd pil upp eller ner, eller använd tabbtangenten. Använd enter för att välja.
    `,
    path: "Sökväg:",
    foundIn: "Hittad i",
  ...
  defaultdialogs: {
    ...
    confirmdeleteNumberOfItems: "Är du säker på att du vill ta bort <strong>%0%</strong> av <strong>%1%</strong> objekt",
    ...
    regexSearchError: "<a target='_blank' rel='noopener' href='http://regexlib.com'>regexlib.com</a>'s webbtjänst har för närvarande driftsstörningar. Tyvärr kan vi inte göra något åt detta.",
    ...
    siterepublished: "Cache för webbplatsen har uppdaterats. Allt publicerat innehåll är nu uppdaterat. Innehåll som inte har publicerats är fortfarande opublicerat.",
    siterepublishHelp: "Webbplatsens cache kommer att uppdateras. Allt innehåll som är publicerat kommer att uppdateras. Innehåll som inte är publicerat kommer att förbli opublicerat.",
  ...
  dictionaryItem: {
    description: "Redigera de olika översättningarna för ordboksinlägget %0% nedan. Du kan lägga till ytterligare språk under 'språk' i menyn till vänster.",
  ...
  errorHandling: {
    errorButDataWasSaved: "Informationen har sparats, men innan du kan publicera denna sida måste du åtgärda följande fel:",
    errorChangingProviderPassword: "Det går inte att byta lösenord i den medlemshanterare du har valt (EnablePasswordRetrieval måste vara satt till 'true').",
  ...
  errors: {
    codemirroriewarning: "Även om CodeMirror är aktiverad i konfigurationen, så är den avaktiverad i Internet Explorer på grund av att den inte är tillräckligt stabil",
    ...
    pictureResizeBiggerThanOrg: "Du kommer att göra bilden större än originalstorleken. Är du säker på att du vill fortsätta?",
  ...
  installer: {
    ...
    databaseInstallDone: "Nu har Umbraco %0% kopierats till din databas. Tryck <strong>Nästa</strong> för att fortsätta.",
    databaseText: 'För att avsluta det här steget måste du veta lite information om din databasserver ("connection string").<br /> Eventuellt kan du behöva kontakta ditt webb-hotell. Om du installerar på en lokal maskin eller server kan du få informationen från din systemadministratör.',
    databaseUpgrade: "<p> Tryck <strong>Uppgradera</strong> knappen för att uppgradera din databas till Umbraco %0%</p> <p> Du behöver inte vara orolig. Inget innehåll kommer att raderas och efteråt kommer allt att fungera som vanligt! </p>",
    databaseUpgradeDone: "Din databas har nu uppgraderats till den senaste versionen %0%.<br />Tryck <strong>Nästa</strong> för att fortsätta.",
    databaseUpToDate: "Din nuvarande databas behöver inte uppgraderas! Klicka <strong>Nästa</strong> för att fortsätta med konfigurationsguiden",
    defaultUserChangePass: "<strong>Lösenordet på standardanvändaren måste bytas!</strong>",
    defaultUserDisabled: "<strong>Standardanvändaren har avaktiverats eller har inte åtkomst till Umbraco!</strong></p><p>Du behöver inte göra något ytterligare här. Klicka <strong>Next</strong> för att fortsätta.",
    defaultUserPassChanged: "<strong>Standardanvändarens lösenord har ändrats sedan installationen!</strong></p><p>Du behöver inte göra något ytterligare här. Klicka <strong>Nästa</strong> för att fortsätta.",
    ...
    permissionsAlmostPerfect: `<strong>Dina rättighetsinställningar är nästa perfekta!</strong>
    ...
    permissionsHowtoResolveText: "Titta på vår <strong>video-självstudiekurs</strong> om hur du konfigurerar mapp-rättigheter för Umbraco eller läs text-versionen.",
    permissionsMaybeAnIssue: "<strong>Dina rättighetsinställningar kan vara ett problem!</strong><br /><br /> Du kan köra Umbraco utan problem, men du kommer inte att kunna skapa mappar eller installera paket vilket är rekommenderat för att kunna utnyttja Umbraco fullt ut.",
    permissionsNotReady: "<strong>Dina rättighetsinställningar är inte reda för Umbraco!</strong> <br /><br /> För att kunna köra Umbraco måste du ändra dina rättighetsinställningar.",
    permissionsPerfect: "<strong>Dina rättighetsinställningar är perfekta!</strong><br /><br />Du är redo att köra Umbraco och installera paket!",
    permissionsResolveFolderIssues: "Lösa mapp problem",
    permissionsResolveFolderIssuesLink: "Följ den här länken för mer information om problem med ASP.NET och att skapa mappar",
    permissionsSettingUpPermissions: "Konfigurerar mapprättigheter",
    permissionsText: "Umbraco behöver skriv/ändra rättigheter till vissa mappar för att spara filer som bilder och PDFer. Umbraco sparar också temporär data (så kallad cache) för att öka prestandan på din webbplats.",
    runwayFromScratch: "Jag vill börja från början",
    runwayFromScratchText: 'Just nu är din webbplats för fullständigt tom och det är ju perfekt om du vill börja från början med att skapa dina egna dokumentyper och mallar. (<a href="https://umbraco.tv/documentation/videos/for-site-builders/foundation/document-types">lär dig hur</a>) Du kan fortfarande välja att installera Runway senare. Gå in i Utvecklarsektionen och välj Paket.',
    ...
    theEndBrowseSite: "<h3>Besök din nya webbplats</h3> Du installerade Runway, så varför inte se hur din nya webbplats ser ut.",
    theEndFurtherHelp: "<h3>Ytterligare hjälp och information</h3> Få hjälp från våra prisbelönta community, bläddra i dokumentationen eller titta på några gratis videor om hur man bygger en enkel webbplats, hur du använder paket eller en snabbguide till Umbracos terminologi",
    theEndHeader: "Umbraco %0% är installerat och klart för användning",
    theEndInstallSuccess: 'Du kan <strong>börja omedelbart</strong> genom att klicka på "Starta Umbraco"-knappen nedan. <br />Om du är en <strong>ny Umbraco användare</strong>kan du hitta massor av resurser på våra kom igång sidor.',
    theEndOpenUmbraco: "<h3>Starta Umbraco</h3> För att administrera din webbplats öppnar du bara Umbraco backoffice och börjar lägga till innehåll, uppdatera mallar och stilmallar eller lägga till nya funktioner.",
    Unavailable: "Anslutningen till databasen misslyckades.",
    watch: "Se",
    welcomeIntro: 'Den här guiden kommer att guida dig genom processen med att konfigurera <strong>Umbraco %0%</strong> antingen för en ny installation eller en uppgradering från version 3.0. <br /><br /> Tryck på <strong>"next"</strong> för att börja.',
  ...
  moveOrCopy: {
    ...
    notAllowedByContentType: "Den aktuella sidan får inte vara undersida till den valda sidan eftersom den har fel dokumenttyp.",
    notAllowedByPath: "Den aktuella sidan kan inte flyttas till en av sina egna undersidor.",
    notValid: "Händelsen är inte tillåten på grund av att du inte har tillräckliga rättigheter till 1 eller flera underliggande sidor",
  ...
  packager: {
    chooseLocalPackageText: 'Välj ett installationspaket, genom att klicka på utforska<br />och leta upp paketet. Umbracos installationspaket har oftast filändelsen ".umb" eller ".zip".',
    ...
    packageNoItemsText: 'Paketfilen innehåller inga poster som kan avinstalleras.<br/><br/>Det är säkert att ta bort den ur systemet genom att klicka på "avinstallera paket" nedan.',
    ...
    packageUninstallText: 'Nedan kan du avmarkera de poster du inte vill avinstallera just nu. När du klickar på "bekräfta avinstallation" kommer alla markerade poster att avinstalleras.<br/><span style="color: Red; font-weight: bold;">OBS!</span> dokument, media osv som använder de borttagna posterna kommer sluta fungera vilket kan leda till att systemet blir instabilt. Avinstallera därför med försiktighet. Om du är osäker, kontakta personen som skapat paketet.',
    packageVersion: "Paketversion"
  },
  paste: {
    doNothing: "Klistra in med helt bibehållen formatering (rekommenderas ej)",
    errorMessage: "Texten du försöker klistra in innehåller specialtecken och/eller formateringstaggar. Detta kan bero på att texten kommer från t.ex. Microsoft Word. Umbraco kan ta bort specialtecken och formateringstaggar automatiskt så att innehållet lämpar sig bättre för webbpublicering.",
  ...
  publicAccess: {
    ...
    paAdvancedHelp: "Välj detta alternativ om du vill skydda sidan med hjälp av rollbaserat lösenordsskydd.<br /> Då används Umbracos medlemsgrupper.",
    ...
    paSimpleHelp: "Välj detta alternativ om du vill skydda sidan med ett enkelt användarnamn och lösenord. Alla loggar då in med samma inloggningsuppgifter."
  },
  publish: {
    contentPublishedFailedAwaitingRelease: " %0% kunde inte publiceras på grund av dess tidsinställda publicering.",
    contentPublishedFailedByEvent: "%0% kunde inte publiceras på grund av att ett tredjepartstillägg avbröt publiceringen.",
    contentPublishedFailedByParent: "%0% kan inte publiceras, på grund av att överordnad nod inte är publicerad.",
    contentPublishedFailedInvalid: "%0% kunde inte publiceras på grund av följande orsaker:  %1%  passerade inte valideringen.",
    ...
    publishHelp: "Klicka på <em>ok</em> för att publicera <strong>%0%</strong>. Därmed blir innehållet publikt.<br/><br /> Du kan publicera denna sida och alla dess undersidor genom att kryssa i <em>publicera alla undersidor</em>. "
  },
  references: {
  ...
  rollback: {
    diffHelp: "Här visas skillnaderna mellan nuvarande version och vald version<br /><del>Röd</del> text kommer inte att synas i den valda versionen. , <ins>Grön betyder att den har tillkommit</ins>",
    documentRolledBack: "Dokumentet har återgått till en tidigare version",
    htmlHelp: 'Här visas den valda sidversionen i HTML. Om du vill se skillnaden mellan två versioner samtidigt, välj istället "Diff".',
  ...
  settings: {
    ...
    importDocumentTypeHelp: 'För att importera en dokumenttyp, leta upp ".udt"-filen på din hårddisk genom att klicka på "Browse"-knappen och sedan på "Importera" (du får bekräfta ditt val i nästa steg).',
    newtabname: "Namn på ny flik",
    nodetype: "Nodtyp",
    noPropertiesDefinedOnTab: 'Inga egenskaper definierade i denna sektion. Klicka på "Lägg till ny egenskap" länken vid toppen för att skapa en ny egenskap.',
    objecttype: "Typ",
    script: "Skript",
    stylesheet: "Stilmall",
    tab: "Flik",
  ...
  sort: {
    ...
    sortHelp: "Välj i vilken ordning du vill ha sidorna genom att dra dem upp eller ner i listan. Du kan också klicka på kolumnrubrikerna för att sortera grupper av sidor",
  ...
  speechBubbles: {
    ...
    editContentPublishedFailedByParent: "Det gick inte att publicera sidan eftersom dess överordnade sida inte är publicerad",
  ...
  translation: {
    ...
    mailBody: "Hej %0%. Detta är ett automatisk mail skickat for att informera dig om att det finns en översättningsförfrågan på dokument '%1%' till '%5%' skickad av %2%. För att redigera, besök http://%3%/translation/details.aspx?id=%4%. För att få en översikt över dina översättningsuppgigter loggar du in i Umbraco på: http://%3%",
    noTranslators: "Hittade inga användare som är översättare. Vänligen skapa en användare som är översättare innan du börjar skicka innehåll för översättning",
    ...
    translationDoneHelp: "Du kan förhandsgranska sidorna du nyss har översatt genom att klicka nedan. Om originalsidan finns kommer du att se en jämförelse mellan din sida och originalsidan.",
  ...
  user: {
    ...
    changePasswordDescription: 'Du kan byta ditt lösenord för Umbraco backoffice genom att fylla i nedanstående formulär och klicka på knappen "Ändra lösenord".',
    contentChannel: "Innehållskanal",
    createAnotherUser: "Skapa en till användare",
    createUserHelp: "Skapa nya användare för att ge dom åtkomst till Umbraco. När en ny användare skapas kommer ett lösenord genereras som du kan dela med användaren.",
    ...
    inviteUserHelp: "Bjud in nya användare för att ge dom åtkomst till Umbraco. Ett e-postmeddelande kommer skikcas till användaren med information om hur man loggar in i Umbraco. Inbjudningar är giltiga i 72 timmar.",
    language: "Språk",
...
//# sourceMappingURL=sv-se-DPtiqhJn.js.map
