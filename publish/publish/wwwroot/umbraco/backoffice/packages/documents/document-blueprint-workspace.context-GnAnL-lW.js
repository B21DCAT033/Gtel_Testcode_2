...
import { i as u, u as c, a as m, x as T } from "./paths-BF32ZUyU.js";
...
class O extends p {
  constructor(n) {
    ...
    }), this.contentTypeUnique = this._data.createObservablePartOfCurrent((t) => t?.documentType.unique), this.observe(this.contentTypeUnique, (t) => this.structure.loadType(t), null), this.routes.setRoutes([
      {
        path: T.toString(),
        component: () => import("./document-blueprint-workspace-editor.element-DPlU6F9G.js"),
        setup: async (t, e) => {
...
//# sourceMappingURL=document-blueprint-workspace.context-GnAnL-lW.js.map
