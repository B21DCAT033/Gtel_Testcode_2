import { UmbDocumentItemRepository as S } from "./document-item.repository-DPoT_JcK.js";
...
let l = class extends U {
  ...
  async firstUpdated() {
    ...
    o(this, n, A).call(this, t), e && o(this, n, z).call(this, e);
  }
  render() {
    return r`
...
A = async function(e) {
  const { data: t } = await a(this, g).requestAllowedChildrenOf(e);
  t && (this._allowedDocumentTypes = t.items);
};
z = async function(e) {
  if (!e) return;
...
//# sourceMappingURL=document-create-options-modal.element-Cf8J3JoH.js.map
