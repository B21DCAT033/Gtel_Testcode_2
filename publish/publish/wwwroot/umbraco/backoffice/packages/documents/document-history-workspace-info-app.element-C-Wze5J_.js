    ...
    return p`
			<umb-workspace-info-app-layout headline="#general_history">
				<umb-extension-with-api-slot
					slot="header-actions"
					type="entityAction"
					.filter=${(t) => r(this, f).has(t.alias)}></umb-extension-with-api-slot>
...
//# sourceMappingURL=document-history-workspace-info-app.element-C-Wze5J_.js.map
