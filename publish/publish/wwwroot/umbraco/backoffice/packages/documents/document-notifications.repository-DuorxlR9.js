...
import { tryExecuteAndNotify as e } from "@umbraco-cms/backoffice/resources";
...
class u {
  ...
  async read(t) {
    ...
    return e(this.#t, s.getDocumentByIdNotifications({ id: t }));
  }
  /**
  ...
  async update(t, i) {
    ...
    return e(
      this.#t,
      s.putDocumentByIdNotifications({ id: t, requestBody: i })
    );
  }
}
class N extends c {
...
export {
  N as UmbDocumentNotificationsRepository,
  N as api
};
//# sourceMappingURL=document-notifications.repository-DuorxlR9.js.map
