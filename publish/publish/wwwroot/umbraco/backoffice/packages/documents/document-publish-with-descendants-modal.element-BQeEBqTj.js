...
}, f = (t, i, e) => i.has(t) || y("Cannot " + e), s = (t, i, e) => (f(t, i, "read from private field"), e ? e.call(t) : i.get(t)), u = (t, i, e) => i.has(t) ? y("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(t) : i.set(t, e), O = (t, i, e, n) => (f(t, i, "write to private field"), i.set(t, e), e), h = (t, i, e) => (f(t, i, "access private method"), e), l, c, d, o, D, M, $, k;
let r = class extends P {
  constructor() {
    super(...arguments), u(this, o), u(this, l, new W(this)), u(this, c, !1), this._options = [], u(this, d, (t) => t.variant ? this.data?.pickableFilter ? this.data.pickableFilter(t) : !0 : !1);
  }
  firstUpdated() {
    h(this, o, D).call(this);
  }
  render() {
    return b`<umb-body-layout headline=${this.localize.term("buttons_publishDescendants")}>
			<p id="subtitle">
...
$ = async function() {
  this.value = {
    ...
    includeUnpublishedDescendants: s(this, c)
...
//# sourceMappingURL=document-publish-with-descendants-modal.element-BQeEBqTj.js.map
