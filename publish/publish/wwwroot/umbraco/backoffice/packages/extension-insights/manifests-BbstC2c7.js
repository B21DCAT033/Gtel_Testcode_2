...
const s = [
...
], n = "Umb.Repository.ExtensionCollection", a = [
  {
    ...
    api: () => import("./extension-collection.repository-DJFH9Y9k.js")
  }
], l = "extension", c = "extension-root", m = "Umb.CollectionView.Extension.Table", E = [
  {
    ...
    element: () => import("./extension-table-collection-view.element-DayZQTE8.js"),
    meta: {
      label: "Table",
      icon: "icon-list",
      pathName: "table"
...
], I = [
  {
    ...
    api: () => import("./unregister-extension.action-ClBNRdQ_.js"),
    forEntityTypes: [l],
    meta: {
      label: "Unregister",
      icon: "icon-trash"
...
//# sourceMappingURL=manifests-BbstC2c7.js.map
