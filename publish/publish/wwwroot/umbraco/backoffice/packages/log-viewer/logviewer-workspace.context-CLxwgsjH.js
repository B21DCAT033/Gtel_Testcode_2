...
class E extends m {
  constructor(t) {
    super(t), this.workspaceAlias = "Umb.Workspace.LogViewer", this.defaultDateRange = {
    ...
    }, this.provideContext(v, this), this.provideContext(g, this), this.#t = new h(t);
  }
  #t;
  getEntityType() {
    return "log-viewer";
...
//# sourceMappingURL=logviewer-workspace.context-CLxwgsjH.js.map
