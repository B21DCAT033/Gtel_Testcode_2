...
const i = [
...
], e = "Umb.Workspace.LogViewer", o = [
  {
    ...
    element: () => import("./logviewer-workspace.element-Ug94NqeS.js"),
    api: () => import("./logviewer-workspace.context-CLxwgsjH.js"),
    meta: {
      entityType: "logviewer"
    }
  },
  {
    ...
    element: () => import("./index-k4uiGmJd.js"),
    weight: 300,
    meta: {
      label: "Overview",
      pathname: "overview",
  ...
  },
  {
    ...
    element: () => import("./index-Cs81Qx4w.js"),
    weight: 200,
    meta: {
