import { y as w, k as U, h as m, A as C, i as O } from "./input-upload-field.element-DpMbvzUB.js";
import "./media-url.repository-DUerHiJb.js";
import { html as h, map as A, state as s, property as P, customElement as g } from "@umbraco-cms/backoffice/external/lit";
import { UmbMediaTypeStructureRepository as q } from "@umbraco-cms/backoffice/media-type";
...
let o = class extends B {
  constructor() {
    super(), f(this, a), this._allowedMediaTypes = [], this._popoverOpen = !1, f(this, _, new q(this)), this.consumeContext(w, (e) => {
  ...
  async firstUpdated() {
    l(this, a, v).call(this, this._mediaTypeUnique ?? "");
  }
  render() {
...
v = async function(e) {
  const { data: t } = await I(this, _).requestAllowedChildrenOf(e);
  t && t.items && (this._allowedMediaTypes = t.items);
};
b = function(e) {
...
o = r([
  g("umb-create-media-collection-action")
], o);
const W = o;
export {
...
//# sourceMappingURL=create-media-collection-action.element-2jaGVPR9.js.map
