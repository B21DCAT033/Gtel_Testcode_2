...
import { D as T } from "./input-upload-field.element-DpMbvzUB.js";
...
let n = class extends E {
  ...
  async firstUpdated() {
    ...
    o(this, s, M).call(this, t), e && o(this, s, b).call(this, e);
  }
  render() {
    return l`
...
M = async function(e) {
  const { data: t } = await w(this, h).requestAllowedChildrenOf(e);
  t && (this._allowedMediaTypes = t.items);
};
b = async function(e) {
  if (!e) return;
...
//# sourceMappingURL=media-create-options-modal.element-COwIuQGN.js.map
