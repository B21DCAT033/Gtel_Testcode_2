import { repeat as z, html as c, css as k, query as P, state as w, property as O, customElement as V } from "@umbraco-cms/backoffice/external/lit";
...
let o = class extends D {
  constructor() {
    super(...arguments), h(this, r), this._value = [], this.editCropAlias = "", h(this, d, ""), h(this, v, new M(this, {
...
I = function(e) {
  ...
  if (this.editCropAlias) {
    const g = this.value.findIndex((q) => q.alias === this.editCropAlias);
    if (g === -1) return;
    const y = [...this.value];
...
o = p([
  V("umb-property-editor-ui-image-crops")
], o);
const N = o;
export {
...
//# sourceMappingURL=property-editor-ui-image-crops.element-BCLh6N5G.js.map
