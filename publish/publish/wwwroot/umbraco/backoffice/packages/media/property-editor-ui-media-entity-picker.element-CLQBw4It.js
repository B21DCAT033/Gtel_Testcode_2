import { html as _, property as l, state as h, customElement as c } from "@umbraco-cms/backoffice/external/lit";
...
}, P = (t, e, r) => e.has(t) || d("Cannot " + r), x = (t, e, r) => e.has(t) ? d("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, r), U = (t, e, r) => (P(t, e, "access private method"), r), p, y;
  ...
  render() {
    return _`
			<umb-input-media
				...
				@change=${U(this, p, y)}></umb-input-media>
		`;
  }
};
...
a = n([
  c("umb-property-editor-ui-media-entity-picker")
], a);
const $ = a;
export {
...
//# sourceMappingURL=property-editor-ui-media-entity-picker.element-CLQBw4It.js.map
