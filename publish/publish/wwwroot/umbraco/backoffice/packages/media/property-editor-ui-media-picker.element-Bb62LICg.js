import { h as y } from "./input-upload-field.element-DpMbvzUB.js";
...
import { UmbFormControlMixin as P, UMB_VALIDATION_EMPTY_LOCALIZATION_KEY as I } from "@umbraco-cms/backoffice/validation";
var M = Object.defineProperty, C = Object.getOwnPropertyDescriptor, h = (e) => {
  throw TypeError(e);
}, i = (e, t, r, l) => {
...
let a = class extends P(v) {
  constructor() {
    super(), T(this, d), this.mandatoryMessage = I, this.readonly = !1, this._focalPointEnabled = !1, this._preselectedCrops = [], this._allowedMediaTypes = [], this._multiple = !1, this._min = 0, this._max = 1 / 0, this.consumeContext(E, (e) => {
...
_ = function(e) {
  ...
  this.value = t ? void 0 : e.target.value, this.dispatchEvent(new f());
};
i([
  m({ type: Boolean })
...
//# sourceMappingURL=property-editor-ui-media-picker.element-Bb62LICg.js.map
