...
import { html as d, repeat as I, nothing as O, css as Z, property as p, state as S, customElement as w } from "@umbraco-cms/backoffice/external/lit";
...
var he = Object.defineProperty, de = Object.getOwnPropertyDescriptor, x = (e) => {
  ...
  for (var o = a > 1 ? void 0 : a ? de(t, r) : t, u = e.length - 1, _; u >= 0; u--)
    (_ = e[u]) && (o = (a ? _(t, r, o) : _(o)) || o);
  return a && o && he(t, r, o), o;
}, G = (e, t, r) => t.has(e) || x("Cannot " + r), i = (e, t, r) => (G(e, t, "read from private field"), r ? r.call(e) : t.get(e)), y = (e, t, r) => t.has(e) ? x("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), be = (e, t, r, a) => (G(e, t, "write to private field"), t.set(e, r), r), b = (e, t, r) => (G(e, t, "access private method"), r), M, f, s, h, k, L, W, N, q, D;
let n = class extends ne(
  oe
) {
  constructor() {
    super(), y(this, h), y(this, M, new ie(this, {
  ...
  render() {
    return d`${b(this, h, W).call(this)} ${b(this, h, N).call(this)}`;
  }
};
...
W = function() {
  if (this._items)
    return d`
      ...
      this._items,
      (e) => e.unique,
      (e) => b(this, h, q).call(this, e)
    )}
			</uui-ref-list>
		`;
};
N = function() {
  return this.max === 1 && this.selection.length >= this.max ? O : this.readonly && this.selection.length > 0 ? O : d`<uui-button
				id="btn-add"
				look="placeholder"
				@click=${b(this, h, k)}
...
q = function(e) {
  return e.unique ? d`
			<uui-ref-node
				...
				<uui-action-bar slot="actions"> ${b(this, h, D).call(this, e)} </uui-action-bar>
				<umb-icon slot="icon" name="icon-users"></umb-icon>
			</uui-ref-node>
		` : O;
};
D = function(e) {
  return this.readonly ? O : d`<uui-button
			@click=${() => b(this, h, L).call(this, e)}
...
l([
  S()
], n.prototype, "_editMemberGroupPath", 2);
l([
  S()
...
class Me {
  ...
  async getCollection(t) {
    const { data: r, error: a } = await ae(this.#e, le.getMemberGroup(t));
    if (a)
      return { error: a };
    if (!r)
...
var fe = Object.defineProperty, Ee = Object.getOwnPropertyDescriptor, z = (e) => {
  ...
  for (var o = a > 1 ? void 0 : a ? Ee(t, r) : t, u = e.length - 1, _; u >= 0; u--)
    (_ = e[u]) && (o = (a ? _(t, r, o) : _(o)) || o);
  return a && o && fe(t, r, o), o;
}, Y = (e, t, r) => t.has(e) || z("Cannot " + r), m = (e, t, r) => (Y(e, t, "read from private field"), r ? r.call(e) : t.get(e)), R = (e, t, r) => t.has(e) ? z("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), C = (e, t, r) => (Y(e, t, "access private method"), r), g, c, E, j, H, V;
let U = class extends J {
  constructor() {
    super(...arguments), R(this, E), this._memberGroups = [], R(this, g, new v(this)), R(this, c, new te(this));
  }
  connectedCallback() {
...
//# sourceMappingURL=member-group-picker-modal.element-CPMPuZSG.js.map
