...
import { html as u, css as w, state as p, customElement as g } from "@umbraco-cms/backoffice/external/lit";
...
}, _ = (t, e, a) => e.has(t) || v("Cannot " + a), h = (t, e, a) => (_(t, e, "read from private field"), e.get(t)), b = (t, e, a) => e.has(t) ? v("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, a), x = (t, e, a, s) => (_(t, e, "write to private field"), e.set(t, a), a), f = (t, e, a) => (_(t, e, "access private method"), a), l, o, C, d;
...
//# sourceMappingURL=member-group-table-collection-view.element-DlXhvYA0.js.map
