...
import { ModelsBuilderService as h, ModelsModeModel as l } from "@umbraco-cms/backoffice/external/backend-api";
...
var y = Object.defineProperty, B = Object.getOwnPropertyDescriptor, i = (e, r, n, d) => {
  for (var o = d > 1 ? void 0 : d ? B(r, n) : r, u = e.length - 1, m; u >= 0; u--)
    (m = e[u]) && (o = (d ? m(r, n, o) : m(o)) || o);
  return d && o && y(r, n, o), o;
};
let a = class extends g {
  ...
  renderList() {
    return this._modelsBuilder?.mode !== l.NOTHING ? t`${this._modelsBuilder?.modelsNamespace ? t`<li>The <strong>models namespace</strong> is ${this._modelsBuilder.modelsNamespace}.</li>` : s}
...
//# sourceMappingURL=models-builder-dashboard.element-x6WFi_zx.js.map
