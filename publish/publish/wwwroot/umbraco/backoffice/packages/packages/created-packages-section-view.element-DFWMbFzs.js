...
var y = Object.defineProperty, w = Object.getOwnPropertyDescriptor, m = (e) => {
  throw TypeError(e);
}, c = (e, t, r, a) => {
  for (var s = a > 1 ? void 0 : a ? w(t, r) : t, n = e.length - 1, p; n >= 0; n--)
    (p = e[n]) && (s = (a ? p(t, r, s) : p(s)) || s);
  return a && s && y(t, r, s), s;
}, h = (e, t, r) => t.has(e) || m("Cannot " + r), E = (e, t, r) => (h(e, t, "read from private field"), t.get(e)), g = (e, t, r) => t.has(e) ? m("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), C = (e, t, r, a) => (h(e, t, "write to private field"), t.set(e, r), r), o;
let i = class extends f {
  ...
  _createRoutes() {
    const e = [
      {
        path: "overview",
        component: () => import("./packages-created-overview.element-DFLetPcB.js")
      }
    ];
    E(this, o)?.map((t) => {
      e.push({
...
//# sourceMappingURL=created-packages-section-view.element-DFWMbFzs.js.map
