...
const n = [
  {
    ...
    api: () => import("./package.repository-C5jRBs59.js")
  },
  {
    type: "store",
    alias: i,
...
], s = [
  {
    ...
    element: () => import("./workspace-package-builder.element-DLyI7hUu.js"),
    meta: {
  ...
  },
  {
    ...
    element: () => import("./installed-packages-section-view.element-CpIn9JN5.js"),
    weight: 200,
    meta: {
  ...
  },
  {
    ...
    element: () => import("./created-packages-section-view.element-DFWMbFzs.js"),
    weight: 100,
    meta: {
