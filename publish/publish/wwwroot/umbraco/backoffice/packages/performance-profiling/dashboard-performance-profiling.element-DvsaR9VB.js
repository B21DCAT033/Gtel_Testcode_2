...
import { unsafeHTML as u, html as s, css as P, state as _, query as S, customElement as v } from "@umbraco-cms/backoffice/external/lit";
...
}, E = (t, e, i) => e.has(t) || m("Cannot " + i), w = (t, e, i) => e.has(t) ? m("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, i), d = (t, e, i) => (E(t, e, "access private method"), i), n, p;
let o = class extends y {
  ...
  async _changeProfilingStatus() {
    const { error: t } = await c(
      this,
      h.putProfilingStatus({ requestBody: { enabled: !this._profilingStatus } })
    );
    t ? d(this, n, p).call(this, this._profilingStatus) : d(this, n, p).call(this, !this._profilingStatus);
  }
...
//# sourceMappingURL=dashboard-performance-profiling.element-DvsaR9VB.js.map
