    ...
    return f`
      ...
      (t) => f`
									<umb-ref-item
										...
										icon=${d(t.meta.icon)}
										@open=${() => n(this, o, g).call(this, t)}></umb-ref-item>
								`
    )}
						</uui-ref-list>
					</uui-box>
				...
				<div slot="actions">
					<uui-button @click=${n(this, o, y)} look="default" label="${this.localize.term("general_close")}"></uui-button>
				</div>
			</umb-body-layout>
		`;
  }
...
//# sourceMappingURL=dynamic-root-origin-picker-modal.element-DWdsQCur.js.map
