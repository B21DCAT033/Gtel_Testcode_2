...
}, P = (e, t, r) => t.has(e) || m("Cannot " + r), b = (e, t, r) => t.has(e) ? m("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), O = (e, t, r) => (P(e, t, "access private method"), r), l, h;
let s = class extends d {
  constructor() {
    super(), b(this, l), this.value = "", this._options = [], this.consumeContext(f, async (e) => {
      const t = e;
      this.observe(
...
//# sourceMappingURL=order-by.element-7pTeZPX6.js.map
