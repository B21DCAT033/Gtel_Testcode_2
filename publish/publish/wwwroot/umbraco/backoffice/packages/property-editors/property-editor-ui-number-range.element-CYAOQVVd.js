...
let n = class extends y(b, void 0) {
  constructor() {
...
_ = function(e) {
  this.value = { min: e.target.minValue, max: e.target.maxValue }, this.dispatchEvent(new E());
};
o([
  l()
...
//# sourceMappingURL=property-editor-ui-number-range.element-CYAOQVVd.js.map
