...
var U = Object.defineProperty, w = Object.getOwnPropertyDescriptor, d = (t) => {
  throw TypeError(t);
}, o = (t, e, r, u) => {
  for (var a = u > 1 ? void 0 : u ? w(e, r) : e, p = t.length - 1, _; p >= 0; p--)
    (_ = t[p]) && (a = (u ? _(e, r, a) : _(a)) || a);
  return u && a && U(e, r, a), a;
...
let i = class extends x(E) {
  constructor() {
    super(), C(this, s), this.readonly = !1, this.consumeContext(P, (t) => {
...
c = function(t) {
  ...
  e !== this.value && (this.value = e, this.dispatchEvent(new g()));
};
i.styles = [
  y`
			uui-input {
...
//# sourceMappingURL=property-editor-ui-number.element-DnA_uDx9.js.map
