...
}, U = (e, r, t) => r.has(e) || l("Cannot " + t), b = (e, r, t) => r.has(e) ? l("Cannot add the same private member more than once") : r instanceof WeakSet ? r.add(e) : r.set(e, t), P = (e, r, t) => (U(e, r, "access private method"), t), u, c;
let o = class extends _ {
  constructor() {
    super(...arguments), b(this, u), this.value = "asc";
  }
  render() {
    return v`<uui-radio-group @input=${P(this, u, c)} value=${this.value}>
...
//# sourceMappingURL=property-editor-ui-order-direction.element-Brb3GvQW.js.map
