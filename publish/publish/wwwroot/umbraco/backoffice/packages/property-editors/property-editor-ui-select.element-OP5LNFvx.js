...
var y = Object.defineProperty, E = Object.getOwnPropertyDescriptor, u = (t) => {
  throw TypeError(t);
}, l = (t, e, r, o) => {
  for (var a = o > 1 ? void 0 : o ? E(e, r) : e, n = t.length - 1, i; n >= 0; n--)
    (i = t[n]) && (a = (o ? i(e, r, a) : i(a)) || a);
  return o && a && y(e, r, a), a;
}, g = (t, e, r) => e.has(t) || u("Cannot " + r), P = (t, e, r) => e.has(t) ? u("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, r), U = (t, e, r) => (g(t, e, "access private method"), r), p, c;
let s = class extends d {
  constructor() {
    super(...arguments), P(this, p), this.value = "", this._options = [];
  }
  set config(t) {
    if (!t) return;
  ...
  render() {
    return v`<uui-select .options=${this._options} @change=${U(this, p, c)}></uui-select>`;
  }
};
...
//# sourceMappingURL=property-editor-ui-select.element-OP5LNFvx.js.map
