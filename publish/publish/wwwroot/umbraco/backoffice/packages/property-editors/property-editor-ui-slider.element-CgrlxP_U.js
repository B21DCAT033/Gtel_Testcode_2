import { html as b, property as u, state as l, customElement as v } from "@umbraco-cms/backoffice/external/lit";
import { UmbLitElement as f } from "@umbraco-cms/backoffice/lit-element";
import { UMB_PROPERTY_CONTEXT as V } from "@umbraco-cms/backoffice/property";
...
let a = class extends f {
  constructor() {
    super(), $(this, o), this.readonly = !1, this._enableRange = !1, this._initVal1 = 0, this._initVal2 = 1, this._step = 1, this._min = 0, this._max = 100, this.consumeContext(V, (t) => {
...
y = function(t) {
  this.value = h(this, o, d).call(this, t.target.value), this.dispatchEvent(new g());
};
r([
  u({ type: Object })
], a.prototype, "value", 2);
...
//# sourceMappingURL=property-editor-ui-slider.element-CgrlxP_U.js.map
