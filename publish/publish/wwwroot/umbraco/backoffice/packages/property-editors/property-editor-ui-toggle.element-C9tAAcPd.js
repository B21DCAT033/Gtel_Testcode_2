import { html as d, property as i, state as n, customElement as b } from "@umbraco-cms/backoffice/external/lit";
...
}, O = (e, t, r) => t.has(e) || _("Cannot " + r), E = (e, t, r) => t.has(e) ? _("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), w = (e, t, r) => (O(e, t, "access private method"), r), m, y;
let a = class extends c(g) {
  constructor() {
...
y = function(e) {
  ...
  this.value = this.mandatory ? t ?? null : t, this.dispatchEvent(new u());
};
o([
  i({ type: String })
], a.prototype, "name", 2);
...
a = o([
  b("umb-property-editor-ui-toggle")
], a);
const B = a;
export {
...
//# sourceMappingURL=property-editor-ui-toggle.element-C9tAAcPd.js.map
