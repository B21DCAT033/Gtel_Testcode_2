...
const _ = "Umb.Repository.Relation.Collection", t = "deleteWithRelation", o = {
  ...
  manifest: {
    ...
    kind: t,
    api: () => import("./bulk-delete-with-relation.action-BmcSzaRl.js")
  }
  ...
  manifest: {
    ...
    api: () => import("./bulk-trash-with-relation.action-C8ci9eyj.js")
  }
};
export {
  _ as U,
...
//# sourceMappingURL=bulk-trash-with-relation.action.kind-KJodVnkL.js.map
