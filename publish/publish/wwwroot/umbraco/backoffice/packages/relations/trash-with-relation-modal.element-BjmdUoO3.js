import { unsafeHTML as v, nothing as g, html as u, css as w, state as p, customElement as C } from "@umbraco-cms/backoffice/external/lit";
...
import "./confirm-action-entity-references.element-CahUBeLL.js";
...
}, m = (t, e, i) => e.has(t) || _("Cannot " + i), f = (t, e, i) => (m(t, e, "read from private field"), e.get(t)), d = (t, e, i) => e.has(t) ? _("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, i), x = (t, e, i, r) => (m(t, e, "write to private field"), e.set(t, i), i), T = (t, e, i) => (m(t, e, "access private method"), i), s, c, y;
  ...
  render() {
    ...
    return u`
			<uui-dialog-layout class="uui-text" headline=${t}>
				...
				${this._referencesConfig ? u`<umb-confirm-action-modal-entity-references
...
//# sourceMappingURL=trash-with-relation-modal.element-BjmdUoO3.js.map
