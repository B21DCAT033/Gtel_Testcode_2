    ...
    super(...arguments), x(this, m), this._routes = [
      {
        ...
        component: () => import("./section-view-examine-indexers-Svvj5tiq.js"),
        setup: (e, t) => {
          const a = e;
      ...
      },
      {
        ...
        component: () => import("./section-view-examine-searchers-DrtY3eii.js"),
        setup: (e, t) => {
          const a = e;
      ...
      {
        path: "",
        component: () => import("./section-view-examine-overview-DMPnZIq2.js")
      },
      {
        path: "**",
...
//# sourceMappingURL=dashboard-examine-management.element-ey0yBKgI.js.map
