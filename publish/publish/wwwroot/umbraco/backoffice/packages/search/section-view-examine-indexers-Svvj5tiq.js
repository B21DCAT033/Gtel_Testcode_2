...
import "./section-view-examine-searchers-DrtY3eii.js";
import { UmbTextStyles as I } from "@umbraco-cms/backoffice/style";
var S = Object.defineProperty, N = Object.getOwnPropertyDescriptor, f = (e) => {
  throw TypeError(e);
}, s = (e, t, a, d) => {
  for (var r = d > 1 ? void 0 : d ? N(t, a) : t, c = e.length - 1, h; c >= 0; c--)
    (h = e[c]) && (r = (d ? h(t, a, r) : h(r)) || r);
  return d && r && S(t, a, r), r;
}, E = (e, t, a) => t.has(e) || f("Cannot " + a), M = (e, t, a) => t.has(e) ? f("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, a), u = (e, t, a) => (E(e, t, "access private method"), a), o, m, x, w;
let n = class extends z {
  ...
  async _rebuild() {
    ...
    const { error: e } = await g(
      this,
      _.postIndexerByIndexNameRebuild({ indexName: this.indexName })
    );
    if (e) {
...
x = async function() {
  const { data: e } = await g(
    this,
    _.getIndexerByIndexName({ indexName: this.indexName })
  );
  return e;
};
w = function(e) {
...
//# sourceMappingURL=section-view-examine-indexers-Svvj5tiq.js.map
