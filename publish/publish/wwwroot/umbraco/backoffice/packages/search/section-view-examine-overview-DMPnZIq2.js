...
let i = class extends y {
  ...
  async _getIndexers() {
    ...
    const { data: e } = await b(this, f.getIndexer({ take: 9999, skip: 0 }));
    this._indexers = e?.items ?? [], this._loadingIndexers = !1;
  }
  async _getSearchers() {
    this._loadingSearchers = !0;
    const { data: e } = await b(this, w.getSearcher({ take: 9999, skip: 0 }));
...
//# sourceMappingURL=section-view-examine-overview-DMPnZIq2.js.map
