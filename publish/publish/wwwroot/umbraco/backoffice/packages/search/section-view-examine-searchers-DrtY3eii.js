...
import { html as s, nothing as M, css as F, property as N, state as c, query as k, customElement as w } from "@umbraco-cms/backoffice/external/lit";
import { UMB_MODAL_MANAGER_CONTEXT as f } from "@umbraco-cms/backoffice/modal";
import { UMB_WORKSPACE_MODAL as z } from "@umbraco-cms/backoffice/workspace";
import { UmbModalRouteRegistrationController as C } from "@umbraco-cms/backoffice/router";
import { SearcherService as R } from "@umbraco-cms/backoffice/external/backend-api";
import { UmbLitElement as A, umbFocus as T } from "@umbraco-cms/backoffice/lit-element";
import { tryExecuteAndNotify as O } from "@umbraco-cms/backoffice/resources";
var U = Object.defineProperty, L = Object.getOwnPropertyDescriptor, x = (e) => {
  throw TypeError(e);
}, n = (e, t, i, a) => {
  for (var r = a > 1 ? void 0 : a ? L(t, i) : t, d = e.length - 1, h; d >= 0; d--)
    (h = e[d]) && (r = (a ? h(t, i, r) : h(r)) || r);
  return a && r && U(t, i, r), r;
}, m = (e, t, i) => t.has(e) || x("Cannot " + i), _ = (e, t, i) => (m(e, t, "read from private field"), i ? i.call(e) : t.get(e)), b = (e, t, i) => t.has(e) ? x("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), P = (e, t, i, a) => (m(e, t, "write to private field"), t.set(e, i), i), p = (e, t, i) => (m(e, t, "access private method"), i), o, u, y, g, v;
let l = class extends A {
  constructor() {
    super(), b(this, u), this._searchLoading = !1, this._workspacePath = "aa", b(this, o, ""), new C(this, z).addAdditionalPath(":entityType").onSetup((e) => ({ data: { entityType: e.entityType, preset: {} } })).observeRouteBuilder((e) => {
  ...
  async _onSearch() {
    ...
    const { data: e } = await O(
      this,
      R.getSearcherBySearcherNameQuery({
  ...
  renderSearchResults() {
    return this._searchLoading ? s`<uui-loader></uui-loader>` : this._searchResults ? this._searchResults.length ? s`<div class="table-container">
      ...
      P(this, o, p(this, u, v).call(this, t));
      ...
      return s`<uui-table-row>
			...
			<button class="field-adder" @click="${p(this, u, y)}">
		...
		</div>` : s`<p>${this.localize.term("examineManagement_noResults")}</p>` : M;
  }
  renderHeadCells() {
...
y = async function() {
  const t = (await this.getContext(f)).open(this, $, {
    value: { fields: this._exposedFields ?? [] }
  });
  await t.onSubmit().catch(() => {
  });
  const i = t.getValue();
  this._exposedFields = i?.fields;
};
g = async function(e) {
  await (await this.getContext(f)).open(this, E, {
    modal: {
      type: "sidebar",
      size: "medium"
    },
...
//# sourceMappingURL=section-view-examine-searchers-DrtY3eii.js.map
