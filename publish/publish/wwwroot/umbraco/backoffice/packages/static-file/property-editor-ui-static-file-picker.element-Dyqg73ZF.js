...
import { html as y, state as v, property as d, customElement as P } from "@umbraco-cms/backoffice/external/lit";
...
let a = class extends g {
  ...
  _onChange(t) {
    s(this, o) ? this._value = t.target.selection[0] : this._value = t.target.selection, this.dispatchEvent(new c());
  }
...
a = h([
  P("umb-property-editor-ui-static-file-picker")
], a);
const F = a;
export {
...
//# sourceMappingURL=property-editor-ui-static-file-picker.element-Dyqg73ZF.js.map
