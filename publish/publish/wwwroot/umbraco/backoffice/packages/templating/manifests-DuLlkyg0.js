...
const n = "Umb.Repository.Script.Item", Y = "Umb.ItemStore.Script", o = "script", e = "script-root", t = "script-folder", a = "Umb.Repository.Script.Rename", _ = "Umb.EntityAction.Script.Rename", T = [
  {
    ...
    api: () => import("./rename-script.repository-D4PlwVxE.js")
  },
  {
    type: "entityAction",
...
], u = new i("UmbScriptDetailStore"), R = "Umb.Repository.Script.Detail", w = "Umb.Store.Script.Detail", E = [
  {
    ...
    weight: 1200,
    api: () => import("./create.action-96KAfuxz.js"),
    forEntityTypes: [e, t],
    meta: {
      icon: "icon-add",
  ...
  },
  {
    ...
    element: () => import("./script-create-options-modal.element-C7iKQMAN.js")
  }
...
), I = "Umb.Workspace.Script.Folder", y = "Umb.EntityAction.Script.Folder.Delete", U = [
  {
    ...
    api: () => import("./script-folder.repository-DNKxxaJ4.js")
  },
  {
    type: "store",
    alias: l,
    name: "Script Folder Store",
    api: () => import("./script-folder.store--1XqGEsJ.js")
  }
], d = [
  {
    type: "workspace",
    ...
    api: () => import("./script-folder-workspace.context-DDd4zvwF.js"),
    meta: {
      entityType: t
    }
  }
...
], r = "Umb.Repository.Script.Tree", P = "Umb.Store.Script.Tree", b = "Umb.Tree.Script", x = [
  {
    ...
    api: () => import("./script-tree.repository-DXpSpRP5.js")
  },
  {
    type: "treeStore",
    alias: P,
    name: "Script Tree Store",
    api: () => import("./script-tree.store-C21OWKAc.js")
  },
  {
    type: "tree",
    kind: "default",
...
], X = new i("UmbScriptTreeStore"), s = "Umb.Workspace.Script", M = "Umb.WorkspaceAction.Script.Save", g = [
  {
    ...
    api: () => import("./script-workspace.context-C0P-b2gC.js"),
    meta: {
      entityType: o
    }
  },
...
//# sourceMappingURL=manifests-DuLlkyg0.js.map
