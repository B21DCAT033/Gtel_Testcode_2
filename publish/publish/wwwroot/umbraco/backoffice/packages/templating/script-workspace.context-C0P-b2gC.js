import { e as C, u as E, s as S } from "./manifests-DuLlkyg0.js";
...
import { html as h, nothing as x, css as R, state as v, customElement as k } from "@umbraco-cms/backoffice/external/lit";
import { UmbLitElement as P } from "@umbraco-cms/backoffice/lit-element";
import "@umbraco-cms/backoffice/code-editor";
import { UmbEntityNamedDetailWorkspaceContextBase as g, UmbWorkspaceIsNewRedirectController as I } from "@umbraco-cms/backoffice/workspace";
...
}, m = (e, t, r) => t.has(e) || y("Cannot " + r), d = (e, t, r) => (m(e, t, "read from private field"), r ? r.call(e) : t.get(e)), _ = (e, t, r) => t.has(e) ? y("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), q = (e, t, r, o) => (m(e, t, "write to private field"), t.set(e, r), r), l = (e, t, r) => (m(e, t, "access private method"), r), n, c, b, f, w;
...
w = function() {
  return this._content === void 0 ? x : h`
			<umb-code-editor
				...
				language="javascript"
				.code=${this._content ?? ""}
				@input=${l(this, c, b)}></umb-code-editor>
		`;
};
a.styles = [
  R`
...
//# sourceMappingURL=script-workspace.context-C0P-b2gC.js.map
