import { nothing as O, repeat as g, ifDefined as P, when as $, html as u, css as A, property as b, state as E, customElement as U } from "@umbraco-cms/backoffice/external/lit";
...
var I = Object.defineProperty, V = Object.getOwnPropertyDescriptor, x = (s) => {
  throw TypeError(s);
}, c = (s, e, t, i) => {
  for (var a = i > 1 ? void 0 : i ? V(e, t) : e, d = s.length - 1, f; d >= 0; d--)
    (f = s[d]) && (a = (i ? f(e, t, a) : f(a)) || a);
  return i && a && I(e, t, a), a;
}, T = (s, e, t) => e.has(s) || x("Cannot " + t), _ = (s, e, t) => (T(s, e, "read from private field"), t ? t.call(s) : e.get(s)), y = (s, e, t) => e.has(s) ? x("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(s) : e.set(s, t), n = (s, e, t) => (T(s, e, "access private method"), t), p, l, w, C, h, v;
const m = "Umb.Tiptap.RichTextEssentials", r = "Umb.Tiptap.Block";
let o = class extends k {
  constructor() {
    super(), y(this, l), y(this, p, /* @__PURE__ */ new Set([m])), this.value = [m], this._extensions = [], this._groups = [], this.consumeContext(B, async (s) => {
      this.observe(
        await s.propertyValueByAlias("blocks"),
        (e) => {
          const t = this.value ? [...this.value] : [];
          if (e?.length)
            t.includes(r) || t.push(r), _(this, p).delete(r);
          else {
            const i = t.indexOf(r) ?? -1;
            i >= 0 && t.splice(i, 1), _(this, p).add(r);
          }
          (!this.value || !n(this, l, w).call(this, t, this.value)) && (n(this, l, h).call(this, t), n(this, l, v).call(this));
        },
        "_observeBlocks"
      );
    });
  ...
  async firstUpdated(s) {
    super.firstUpdated(s), this.observe(S.byType("tiptapExtension"), (e) => {
      ...
      })), this.value || n(this, l, h).call(this, this._extensions.map((t) => t.alias)), n(this, l, v).call(this);
    });
  }
  render() {
        ...
        (e) => u`
									<li title=${P(e.description)}>
										<uui-checkbox
											...
											value=${e.alias}
											?checked=${e.selected}
											?disabled=${_(this, p).has(e.alias)}
											@change=${() => n(this, l, C).call(this, e)}>
											<div class="inner">
												${$(e.icon, () => u`<umb-icon .name=${e.icon}></umb-icon>`)}
...
//# sourceMappingURL=property-editor-ui-tiptap-extensions-configuration.element-CpTKlnH4.js.map
