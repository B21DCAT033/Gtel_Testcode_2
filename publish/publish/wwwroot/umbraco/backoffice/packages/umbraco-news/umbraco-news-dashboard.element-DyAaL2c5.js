...
var b = Object.getOwnPropertyDescriptor, n = (e) => {
  ...
  for (var o = m > 1 ? void 0 : m ? b(r, a) : r, i = e.length - 1, u; i >= 0; i--)
    (u = e[i]) && (o = u(o) || o);
  return o;
}, v = (e, r, a) => r.has(e) || n("Cannot " + a), g = (e, r, a) => (v(e, r, "read from private field"), a ? a.call(e) : r.get(e)), f = (e, r, a) => r.has(e) ? n("Cannot add the same private member more than once") : r instanceof WeakSet ? r.add(e) : r.set(e, a), s;
...
//# sourceMappingURL=umbraco-news-dashboard.element-DyAaL2c5.js.map
