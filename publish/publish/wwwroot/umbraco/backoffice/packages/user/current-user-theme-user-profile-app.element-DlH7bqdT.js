...
var A = Object.defineProperty, b = Object.getOwnPropertyDescriptor, v = (t) => {
  ...
  for (var s = a > 1 ? void 0 : a ? b(e, r) : e, n = t.length - 1, o; n >= 0; n--)
    (o = t[n]) && (s = (a ? o(e, r, s) : o(s)) || s);
  return a && s && A(e, r, s), s;
}, p = (t, e, r) => e.has(t) || v("Cannot " + r), u = (t, e, r) => (p(t, e, "read from private field"), e.get(t)), _ = (t, e, r) => e.has(t) ? v("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, r), x = (t, e, r, a) => (p(t, e, "write to private field"), e.set(t, r), r), w = (t, e, r) => (p(t, e, "access private method"), r), h, m, f;
let i = class extends g {
  constructor() {
    super(), _(this, m), _(this, h), this._themeAlias = null, this._themes = [], this.consumeContext(y, (t) => {
      x(this, h, t), this.observe(
        t.theme,
        (e) => {
          this._themeAlias = e;
        },
...
//# sourceMappingURL=current-user-theme-user-profile-app.element-DlH7bqdT.js.map
