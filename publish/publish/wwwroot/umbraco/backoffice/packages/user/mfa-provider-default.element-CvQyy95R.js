...
import { css as _, property as l, state as d, query as b, customElement as v, html as m } from "@umbraco-cms/backoffice/external/lit";
import { UmbLitElement as y } from "@umbraco-cms/backoffice/lit-element";
import { isApiError as g, tryExecuteAndNotify as C } from "@umbraco-cms/backoffice/resources";
...
var z = Object.defineProperty, x = Object.getOwnPropertyDescriptor, p = (t) => {
  ...
  for (var r = s > 1 ? void 0 : s ? x(e, a) : e, u = t.length - 1, n; u >= 0; u--)
    (n = t[u]) && (r = (s ? n(e, a, r) : n(r)) || r);
  return s && r && z(e, a, r), r;
}, S = (t, e, a) => e.has(t) || p("Cannot " + a), k = (t, e, a) => e.has(t) ? p("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, a), I = (t, e, a) => (S(t, e, "access private method"), a), c, h;
let i = class extends y {
  constructor() {
    super(), k(this, c), this.providerName = "", this.displayName = "", this.callback = async () => ({}), this.close = () => {
    }, this._loading = !0, this._secret = "", this._qrCodeSetupImageUrl = "", this.consumeContext(w, (t) => {
      this.notificationContext = t;
    });
  }
  async firstUpdated() {
    await I(this, c, h).call(this), this._loading = !1;
  }
  render() {
  ...
  async submit(t) {
    ...
    r ? (this._buttonState = "failed", g(r) ? r.body.operationStatus === "InvalidCode" ? (this.codeField?.setCustomValidity(this.localize.term("user_2faInvalidCode")), this.codeField?.focus()) : this.peek(
...
h = async function() {
  ...
  const { data: t } = await C(
    this,
    f.getUserCurrent2FaByProviderName({ providerName: this.providerName })
  ), e = t;
  if (!e)
...
//# sourceMappingURL=mfa-provider-default.element-CvQyy95R.js.map
