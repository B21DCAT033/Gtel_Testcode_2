import { c as i, b as a, r as e, w as m, f as s, e as n, x as r, j as p, n as b, t as l, y as k, z as W, u as O, d as t } from "./paths-Cvoq37Uo.js";
...
const _ = [
  {
    ...
    api: () => import("./webhook-delivery-collection.repository-Cd0gyNue.js")
  }
], y = [
  {
    type: "collectionView",
...
], E = [
  {
    ...
    element: () => import("./webhook-delivery-collection-workspace-view.element-CjauYLxM.js"),
    meta: {
      label: "Deliveries",
      pathname: "deliveries",
      icon: "icon-box-alt",
...
], d = [...A, ...E], f = [
  {
    ...
    js: () => import("./webhook-events-modal.element-CWGnxBve.js")
  }
], I = [...f, ...m], C = [
  {
    type: "repository",
    ...
    api: () => import("./webhook-collection.repository-CCRr8hX8.js")
  }
], w = [
  {
...
], U = [...k, ...W], L = [
  {
    ...
    api: () => import("./webhook-workspace.context-BWH4yuot.js"),
    meta: {
      entityType: l
    }
  },
  {
    ...
    js: () => import("./webhook-details-workspace-view.element-Pe87WxEm.js"),
    weight: 300,
    meta: {
      label: "Details",
      pathname: "details",
