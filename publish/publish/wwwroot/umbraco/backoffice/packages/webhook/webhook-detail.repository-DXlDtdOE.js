import { t as i, l as c } from "./paths-Cvoq37Uo.js";
...
class y {
  ...
  async read(e) {
    ...
    const { data: t, error: r } = await a(this.#e, s.getWebhookById({ id: e }));
...
//# sourceMappingURL=webhook-detail.repository-DXlDtdOE.js.map
