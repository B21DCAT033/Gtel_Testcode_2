import { css as I, property as U, customElement as $, LitElement as B, nothing as k, html as c, state as T } from "@umbraco-cms/backoffice/external/lit";
...
import { q as K } from "./paths-Cvoq37Uo.js";
var X = Object.defineProperty, F = Object.getOwnPropertyDescriptor, N = (t, e, a, s) => {
  for (var n = s > 1 ? void 0 : s ? F(e, a) : e, o = t.length - 1, i; o >= 0; o--)
    (i = t[o]) && (n = (s ? i(e, a, n) : i(n)) || n);
  return s && n && X(e, a, n), n;
};
let v = class extends B {
  render() {
    return this.value ? c`<a href=${"section/settings/workspace/webhook/edit/" + this.value.unique}>${this.value.name}</a>` : k;
  }
};
v.styles = [
  L,
...
var J = Object.defineProperty, Q = Object.getOwnPropertyDescriptor, x = (t) => {
  ...
  for (var n = s > 1 ? void 0 : s ? Q(e, a) : e, o = t.length - 1, i; o >= 0; o--)
    (i = t[o]) && (n = (s ? i(e, a, n) : i(n)) || n);
...
let p = class extends M {
  ...
  render() {
    return this.value ? c`${this._contentTypes}` : k;
  }
};
...
var Z = Object.defineProperty, j = Object.getOwnPropertyDescriptor, S = (t) => {
  ...
  for (var n = s > 1 ? void 0 : s ? j(e, a) : e, o = t.length - 1, i; o >= 0; o--)
    (i = t[o]) && (n = (s ? i(e, a, n) : i(n)) || n);
...
//# sourceMappingURL=webhook-table-collection-view.element-DpQNfLsf.js.map
